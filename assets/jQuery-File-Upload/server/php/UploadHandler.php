...
class UploadHandler {
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => $_SERVER['DOCUMENT_ROOT'].'/reellyou_latest/assets/images/post_images/',
            'upload_url' => $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/reellyou_latest/assets/images/post_images/',
